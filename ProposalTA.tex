...
\begin{center}
    ...
    {\Large\bfseries EKSPERIMEN MULTI-MODEL DAN MULTI-PERSONA UNTUK MENGANALISIS DAMPAK \textit{PERSONA} TERHADAP KUALITAS REASONING, KUALITAS JAWABAN, DAN \textit{HUMAN BIAS} PADA LARGE LANGUAGE MODEL}\\
     \vspace{3cm}
...
\begin{tabular}{p{1cm}p{7cm}p{7cm}}
   ...
   & Dr. Eng. Ayu Purwarianti, S.T., M.T. & Dr. Alham Fikri Aji, S.T., M.Sc. \\[0.2cm]
   &  NIP. x & NIP. x
\end{tabular}
