...
\begin{center}
    ...
    {\Large\bfseries EKSPERIMEN MULTI-MODEL DAN MULTI-PERSONA UNTUK MENGANALISIS DAMPAK \textit{PERSONA} TERHADAP PENALARAN, PERILAKU KELUARAN, DAN \textit{HUMAN BIAS} PADA LARGE LANGUAGE MODEL}\\
     \vspace{3cm}
